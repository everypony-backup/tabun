...
class Router extends LsObject
{
     ...
     * @var string|null
     */
    protected static $sActionEvent=null;
    /**
     * Имя текущего евента
     *
     * @var string|null
     */
    protected static $sActionEventName=null;
    /**
     * Класс текущего экшена
     *
     * @var string|null
     */
    protected static $sActionClass=null;
    /**
     * Текущий полный ЧПУ url
     *
     * @var string|null
     */
    protected static $sPathWebCurrent = null;
    /**
     ...
     * @var array
     */
    protected static $aParams=array();
    /**
     ...
     * @var bool
     */
    protected static $bShowStats=true;
    /**
     * Объект роутинга
     * @see getInstance
     *
     ...
     * @return string
     */
    public static function GetPathWebCurrent()
    {
     ...
     * @return string
     */
    public static function GetActionEvent()
    {
     ...
     * @return string
     */
    public static function GetActionEventName()
    {
     ...
     * @param string $sEvent	Евент
     */
    public static function SetActionEvent($sEvent)
    {
        self::$sActionEvent=$sEvent;
    }
    /**
     ...
     * @return string
     */
    public static function GetParam($iOffset, $def=null)
    {
        $iOffset=(int)$iOffset;
     ...
     * @param mixed $value
     */
    public static function SetParam($iOffset, $value)
    {
     ...
     * @param bool $bState
     */
    public static function SetIsShowStats($bState)
    {
     ...
     * @return bool
     */
    public static function GetIsShowStats()
    {
     ...
     * @return string
     */
    public static function GetPath($action)
    {
