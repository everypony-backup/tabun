...
return array(
	...
	'blog_no_topic' => 'Сюда ещё никто не успел написать',
	'blog_rss' => 'RSS лента',
	'blog_rating' => 'Рейтинг',
	...
	'blog_create_acl' => 'Вы ещё не достаточно окрепли, чтобы создавать свой блог',
	'blog_create_title' => 'Название блога',
	'blog_create_title_notice' => 'Название блога должно быть наполнено смыслом, чтобы можно было понять, о чём будет блог.',
	...
	'blog_admin_delete_success' => 'Блог успешно удалён',
	...
	'blog_user_invite_already_done' => 'Вы уже являетесь подписчиком этого блога',
	...
	'topic_favourite_del_ok' => 'Пост удалён из избранного',
	...
	'topic_create_blog_error_noacl' => 'Вы ещё не достаточно окрепли, чтобы постить в этот блог',
	'topic_create_blog_error_noallow' => 'Вы не можете писать в этот блог',
	'topic_create_blog_notice' => 'Чтобы написать в определённый блог, вы должны для начала вступить в него.',
	'topic_create_title' => 'Заголовок',
	'topic_create_title_notice' => 'Заголовок должен быть наполнен смыслом, чтобы можно было понять, о чём будет пост.',
	...
	'topic_question_vote_ok' => 'Ваш голос учтён.',
	'topic_question_vote_already' => 'Ваш голос уже учтён!',
	...
	'topic_question_create_title_notice' => 'Вопрос должен быть наполнен смыслом, чтобы можно было понять, о чём будет опрос.',
	...
	'comment_was_delete' => 'комментарий был удалён',
	...
	'comment_vote_ok' => 'Ваш голос учтён',
	...
	'comment_favourite_del_ok' => 'Комментарий удалён из избранного',
	/**
	 * Люди
	 */
	'people' => 'Брони',
	...
	'user_exit_notice' => 'Ты всё равно вернёшься!',
	...
	'registration_login_notice' => 'Может состоять только из букв (A-Z a-z), цифр (0-9). Знак подчёркивания (_) лучше не использовать. Длина логина не может быть меньше 3 и больше 30 символов.',
	...
	'settings_profile_mail_error_used' => 'Этот e-mail уже используется',
	...
	'settings_profile_mail_change_to_notice' => 'Спасибо! <br/> На ваш новый почтовый адрес отправлено подтверждение для смены старого e-mail.',
	'settings_profile_mail_change_ok' => 'Ваш e-mail изменён на <b>%%mail%%</b>',
	...
	'settings_profile_password_confirm' => 'Ещё раз новый пароль',
	...
	'settings_account_submit_ok' => 'Аккаунт сохранён',
	/**
	 * Меню настроек
	 */
	...
	'talk_blacklist_delete_ok' => 'Пользователь <b>%%login%%</b> успешно удалён',
	...
	'talk_speaker_delete_ok' => 'Участник <b>%%login%%</b> успешно удалён',
	...
	'uploadimg_url_error_network' => 'Ошибка удалённого сервера',
	...
	'admin_topics_recalculated' => 'Количество постов пересчитано',
	/**
	...
	'plugins_activation_overlap' => 'Конфликт с активированным плагином. Ресурс %%resource%% переопределён на %%delegate%% плагином %%plugin%%.',
	...
	'tags_help_standart_s' => 'Текст между этими тегами будет отображаться как зачёркнутый.',
	'tags_help_standart_u' => 'Текст между этими тегами будет отображаться как подчёркнутый.',
	...
	'system_error_404' => 'К сожалению, такой страницы не существует. Вероятно, она была удалена с сервера, либо её здесь никогда не было.',
	...
	'timezone_list'=> array(
		...
		'3' => '[UTC + 3] Калининград, Минск, Москва',
		'3.5' => '[UTC + 3:30] Тегеран',
		'4' => '[UTC + 4] Волгоград, Самара, Санкт-Петербург, Баку, Ереван, Тбилиси',
		'4.5' => '[UTC + 4:30] Кабул',
