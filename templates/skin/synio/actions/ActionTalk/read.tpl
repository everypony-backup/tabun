...
<article class="topic topic-type-talk">
	...
	<footer class="topic-footer">
		<ul class="topic-info">
			...
			<li class="topic-info-favourite" onclick="return ls.favourite.toggle({$oTalk->getId()},$('#fav_topic_{$oTalk->getId()}'),'talk');"><i id="fav_topic_{$oTalk->getId()}" class="favourite {if $oTalk->getIsFavourite()}active{/if}">В избранное</i></li>
