<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/"> 
	...
	<Image height="64" width="64" type="image/png">{cfg name='path.static.url'}/local/logo.png</Image>
	<Image height="16" width="16" type="image/vnd.microsoft.icon">{cfg name='path.static.url'}/local/favicon.ico</Image>
