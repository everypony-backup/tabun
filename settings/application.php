...
$config['view']['processing']['img_max_width'] = 1000;       // максимальная ширина обрабатываемых изображений в пикселях
$config['view']['processing']['img_max_height'] = 1000;      // максимальная высота обрабатываемых изображений в пикселях
